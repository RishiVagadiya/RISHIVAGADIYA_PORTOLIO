...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const allSections = ['home', 'about', 'projects', 'certifications', 'skills', 'contact'];
    ...
    const certClose = document.querySelector('.certificate-modal-close');
...
function initializeButtons() {
    ...
    const certificationButtons = document.querySelectorAll('.certification-view-btn');
    certificationButtons.forEach(btn => {
    ...
    overlay.innerHTML = `
        <div class="menu-content">
            ...
            <ul>
                ...
                <li><a href="#certifications" onclick="navigateToSection('certifications')">Certifications</a></li>
...
function openResume() {
    ...
    const resumePath = 'Rishi_Patel_Resume.PDF';
...
function openCertificate(certId) {
    const certificateMap = {
        'google-analytics': 'google-analytics-certificate.jpg',
        'google-gemini': 'google-gemini-certificate.jpg',
        'cisco-network-defense': 'cisco-network-defense-certificate.jpg'
    };

    const imageSrc = certificateMap[certId];
    if (!imageSrc) {
        console.error('Unknown certificate id:', certId);
        return;
    }
